...
CD_DIRNAME=${0%apt-auto-installs-copy.sh}  #precede with cd to cd into basename directory (cd $CD_DIRNAME)
#cd ${0%apt-auto-installs-copy.sh}    
cd $CD_DIRNAME
...
function FUN_WARES_FOR_ALL {
	...
	PKG_NAME="mat2 metadata anonimyzer"
	FUN_VERBOSE_INSTALLING
	...
	PKG_NAME="CUBIC adding ppa CUBIC"
	FUN_VERBOSE_INSTALLING
	####
	...
	sudo apt update
	sudo apt install --no-install-recommends -y cubic
...
echo -e "\n 1.- APT-AUTO-INSTALLS  FOR UBUNTU MATE SPECIFICALLY "
echo -e "\n 2- UBUNTU MATE HARDWARE FIXES [ Specific to lenovo ideapad S130-14IGM] "
echo -e "\n 3.- UBUNTU MATE MANUALLY INSTALLED WARES"
...
1)
	echo "You Have Chosen  1-APT-AUTO-INSTALLS  FOR UBUNTU MATE SPECIFICALLY "
	source ./WARES-LIB/UBUNTU_MATE_SPECIFIC_WARES_EXT_LIB
	FUN_WARES_FOR_UBUNTU_MATE_SPECIFIC
	#FUN_KERNEL_PARAMETERS_FOR_ALL
	echo "	All DONE	:D  :-)"
	;;

2)
	echo "You Have Chosen   2- UBUNTU MATE HARDWARE FIXES [ Specific to lenovo ideapad S130-14IGM]"
	source ./WARES-LIB/UBUNTU_MATE_HARDWARE_FIXES_EXT_LIB
	FUN_HARDWARE_FIXES_UBUNTU_MATE
...
3)
	echo "You Have Chosen  3.- UBUNTU MATE MANUALLY INSTALLED WARES "
	source ./WARES-LIB/UBUNTU_MATE_MANUALLY_INSTALLED_WARES_EXT_LIB

	FUN_WARES_UBUNTU_MATE_MANUALLY_INSTALLED_WARES
